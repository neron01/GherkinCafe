...
<template>
    <v-layout row wrap text-xs-left>
        <v-flex xs9>
            <h1 class="title">Report {{ formatDate(reportState.selectedReport.startTime) }}</h1>
            <span class="pr-2"
                >{{ reportState.selectedReport.passed }}/{{ reportState.selectedReport.total }} Passed</span
            >
            <span class="px-2"
            ...
            >
            <span class="pl-2"
                >{{ reportState.selectedReport.skipped }}/{{ reportState.selectedReport.total }} Skipped</span
            >
        </v-flex>
        ...
        <v-flex xs12>
            ...
            <span v-if="reportState.selectedReport.tags && reportState.selectedReport.tags.length > 0"
        ...
        <v-flex>
            ...
            >
                ...
                <template slot="items" slot-scope="props">
                    <router-link
                        tag="tr"
                        :to="{ name: 'tests-id', params: { id: props.item._id }, hash: '#a' + props.item._id }"
                        class="table-row"
                        v-bind:class="{
