<template>
    <div class="wrapper">
        <a @click.prevent="modalShown = true;"> {{ auth.authUser ? auth.authUser.email : 'Sign in' }} ▾ </a>
            ...
            <div v-else>
                <form @submit.prevent="authSubmit">
                    ...
                    <p v-if="mode.register">
                        Password (Again): <input type="password" v-model="form.passwordAgain" name="passwordAgain" />
                    </p>
